...
public class Constants {
    ...
    public static final String TooltipAutoGenCred = "If checked, a unique user identifier (UUID) is required to generate username and password.";
    ...
    public static final String TooltipOptimization = "If checked, fastest servers will be fetched based on the smartest ping response.";
